...
df = fetch_dataset('MLD Daily Temperature Taking Responses 2021-10-25_2021-10-31 - Copy.xlsx')
...
attendance_checker = pd.read_excel('attendance_checker.xlsx', index_col='email')
...
fig, ax = plt.subplots()
sns.lineplot(x, y01, color ='k', linestyle='--', linewidth=2, marker='.', markersize=12, label='FMA')
sns.lineplot(x, y02, color='b', linestyle='-.', linewidth=3, marker='o', markersize=10, label='IBC')
